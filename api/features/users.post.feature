...
Funcionalidade: POST /api/users — Criação de usuários, login e registro
  ...
  @CT018-REALIZAR-LOGIN-COM-CREDENCIAIS-VALIDAS
  ...
  @CT020-CRIAR-USUARIO-COM-CORPO-VAZIO
  ...
  @CT021-REALIZAR-LOGIN-SEM-SENHA
  ...
  @CT022-REGISTRAR-USUARIO-COM-EMAIL-NAO-CADASTRADO
  ...
  @CT023-REALIZAR-LOGIN-COM-SENHA-INCORRETA
